...
dashboardPage(
  dashboardHeader(dropdownMenuOutput("dropdownmenu"),
                  title = "DASHBOARD PMK UPDL PANDAAN",dropdownMenuOutput("msgOutput")
  ),
  ...
  dashboardSidebar(
    sidebarMenu(id= "tabs", width = 350,
                ...
                menuItem("Google Drive", icon = icon("hand-pointer"), tabName = "doitYourself"),
      ...
      tabItems(
        tabItem(tabName = "home",
                ...
                fluidRow(
                  ...
                  box(DT::dataTableOutput("upcoming_deadlines"), width = 4,solidHeader = TRUE, status = "primary", title = "Upcoming Deadlines", collapsible = TRUE),
                  box(DTOutput("overdue_tasks"), width = 8,solidHeader = TRUE, status = "primary", title = "Overdue Tasks", collapsible = TRUE),
