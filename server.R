shinyServer(function(input, output, session){ 
  ...
  dt_excel<- reactive({raw_data_excel})
  dt_sheet<- reactive({raw_data_sheet})
  ...
  #   data <-dt_excel
   # output$upcoming_deadlines <- renderDT({
    # df_tmp_upcoming <- dt_excel()
    # 
    # # df_tmp_upcoming$nama_kota <- dmy(df_tmp_upcoming$nama_kota)
    # # df_tmp_upcoming$nama_jenjang <- dmy(df_tmp_upcoming$nama_jenjang)
    # df_tmp_upcoming$standar_isi <- dmy(df_tmp_upcoming$standar_isi)
    # df_tmp_upcoming$standar_proses <- dmy(df_tmp_upcoming$standar_proses)
    # df_tmp_upcoming$standar_kompetensi <- dmy(df_tmp_upcoming$standar_kompetensi)
    # df_tmp_upcoming$standar_pendidik <- dmy(df_tmp_upcoming$standar_pendidik)
    # 
    # df_tmp_upcoming <- df_tmp_upcoming%>% 
    # 
      df_tmp_upcoming <- dt_sheet()
      datatable(df_tmp_upcoming, options = list(pageLength = 5 ))
    # 
